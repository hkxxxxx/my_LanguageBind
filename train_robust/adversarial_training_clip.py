...
from train_robust.datasets import COCOFlickrDataset, ImageNetDataset
...
import wandb
from train_robust.utils import init_wandb, AverageMeter
from train_robust.sam_data import SamData
# from open_flamingo.eval.models.utils import unwrap_model
from train_robust.utils import str2bool
...
class ComputeLossWrapper:
    ...
    def __call__(self, embedding, targets):
        ...
        if isinstance(embedding, dict):
            embedding = embedding['image_features']
            # print(f"Extracted image_features from dict")
