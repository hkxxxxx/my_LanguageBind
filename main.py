...
from languagebind import LanguageBindImageTokenizer
...
tokenizer = LanguageBindImageTokenizer.from_pretrained(pretrained_ckpt, cache_dir='/root/autodl-tmp/LanguageBind/cache_dir/tokenizer_cache_dir')
...
def main(args):
    ...
    # initialize datasets
    data = get_data(args, tokenizer=tokenizer)
